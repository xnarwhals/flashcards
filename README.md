...
* [x] vfx confetti when correct + auto flip when correct
* [x] pseudo anti-cheat measures
...
Fun to build upon last flashcard project. The most challenging part was adding in shuffle and "mastered" cards.
